...
const App = (props) => {
  ...
  const [{
  ...
  },
    {
      ...
      onDiceTossed,
      onFormSubmit
    }] = useGame(initialPosition);

  const [{ currentBottom, currentLeft }] = position;
  ...
  return (
    <div className="container">
      ...
      <div className="play-board">
        <img src={playboard} className="play-board-img" alt="play-board" />
        {currentStateOfGame && <img src={locationIcon} className="play-location-img" style={{ bottom: 3 + currentBottom + '%', left: 4 + currentLeft + '%' }} alt="location" />}
      ...
      <div className="input-board">
        ...
        {currentStateOfGame && <Form
          onFormSubmit={onFormSubmit}
          onDiceTossed={onDiceTossed}
          resetApp={resetGame}
        />}
      </div>
